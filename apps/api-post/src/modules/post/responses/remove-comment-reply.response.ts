...
export class RemoveCommentReplyResponse {
    ...
    @ApiPropertyOptional({
        ...
        example: 'cmt_2d4e6f8a-0b1c-3d5e-7f9a-0123456789ab',
    })
    commentId?: string;

    @ApiPropertyOptional({
        description: 'ID of the removed reply.',
    ...
    @ApiPropertyOptional({
        description: 'Replies remaining under the parent comment after removal.',
        example: 2,
        minimum: 0,
    })
    repliesCount?: number;
